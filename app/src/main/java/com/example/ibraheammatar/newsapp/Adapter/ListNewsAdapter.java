package com.example.ibraheammatar.newsapp.Adapter;
...
import com.example.ibraheammatar.newsapp.Common.ISO8601Parse;
import com.example.ibraheammatar.newsapp.DetailArticle;
import com.example.ibraheammatar.newsapp.Interface.ItemClickListener;
import com.example.ibraheammatar.newsapp.Model.Article;
import com.example.ibraheammatar.newsapp.R;
...
public class ListNewsAdapter extends RecyclerView.Adapter<ListNewsViewHolder> {
    ...
    public void onBindViewHolder(ListNewsViewHolder holder, int position) {
        ...
        if(articleList.get(position).getPublishedAt() != null) {
            ...
            holder.article_time.setReferenceTime(((Date) date).getTime());
        }
